...
function uploadNext(volumes, files, i)
{
    ...
    {
        if(isNaN(parseFloat(volumes[0]))) //only use increment if is number
        {
            formData.append("volume", volumes[0]);
        }
        else
        {
